        ...
        <div className="hero-inner">
          ...
          <div className="hero-preview">
            <div className="hero-preview-bar">
              ...
              <span className="bar-url">localhost:8080/swagger-new-ui.html</span>
            </div>
            <div className="hero-preview-body">
              <img src="/swagger-home-dark.png" alt="Swagger New UI Dark" className="preview-img preview-img-dark" />
              <img src="/swagger-home-light.png" alt="Swagger New UI Light" className="preview-img preview-img-light" />
            </div>
          </div>
        </div>
      </section>
