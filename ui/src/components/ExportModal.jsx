...
const EXPORT_FORMATS = [
  ...
  { id: 'markdown', label: 'Markdown', description: 'Markdown documentation', enabled: false },
]
...
function ExportModal({ isOpen, onClose, apiData }) {
  ...
  const handleExport = () => {
    if (!apiData || selectedFormat !== 'json') return
      ...
      <div className="modal-content export-modal-content">
        ...
        <div className="modal-footer">
          ...
          <button 
            ...
            disabled={selectedEndpoints.size === 0 || selectedFormat !== 'json'}
          >
